...
- ROLLER Data API is not suitable for live account reads; it is only a possible source for scheduled export/reconciliation later.
...
- If ROLLER-side export repair is needed later, keep it as a scheduled Data API job, not a live request path.
